    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          const _NotifToggle(title: 'Thông báo đơn hàng', prefKey: 'notif_orders'),
          const _NotifToggle(title: 'Thông báo khuyến mãi', prefKey: 'notif_promo'),
          const _NotifToggle(title: 'Thông báo xã hội', prefKey: 'notif_social'),
...
class _ChangePasswordSheetState extends State<_ChangePasswordSheet> {
  ...
  Future<void> _submit() async {
    ...
    try {
      await DioClient.instance.post(ApiEndpoints.changePassword, data: {
