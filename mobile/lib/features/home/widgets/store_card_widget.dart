...
// ── Compact horizontal card (groups 1-5) ─────────────────────────────────────
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            _CoverImage(url: store.coverImage ?? store.avatarImage, height: 100),
            Padding(
...
// ── Full-width vertical card (group 6) ───────────────────────────────────────
    ...
    return Container(
      ...
      child: Text(
        ...
        style: TextStyle(
          ...
          color: open ? const Color(0xFF388E3C) : const Color(0xFFE53935),
        ),
      ),
    );
  }
